 ...
 *
 * Disassembly of dsdt.dat, Wed Jul 19 17:56:15 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000AC8F (44175)
 *     Revision         0x02
 *     Checksum         0x95
 *     OEM ID           "SECCSD"
 ...
 */
DefinitionBlock ("", "DSDT", 2, "SECCSD", "LH43STAR", 0x00000022)
{
    /*
    ...
    External (_SB_.PCI0.GFX0.AFN4, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    External (_SB_.PCI0.IEIT.EITV, MethodObj)    // Warning: Unknown method, guessing 0 arguments
    External (_SB_.PCI0.PEG0.PEGP.AINT, MethodObj)    // Warning: Unknown method, guessing 2 arguments
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xBA194E18, 0x01D1)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xBA051E18, 0x10)
    ...
    Scope (_TZ)
    {
        ThermalZone (TZ00)
        {
            Method (_TMP, 0, NotSerialized)  // _TMP: Temperature
            {
                ...
                Local0 = \_SB.PCI0.LPCB.EIOR (0xFF, Zero, 0xB0F7)
    ...
    OperationRegion (SAWB, SystemMemory, 0xBA197E98, 0x0037)
    ...
    Scope (_SB.PCI0)
    {
        Device (AMW0)
        {
            ...
            Method (WM00, 3, NotSerialized)
            {
                ...
                PARA = CDBA /* \_SB_.PCI0.AMW0.WM00.CDBA */
                PARB = CDBB /* \_SB_.PCI0.AMW0.WM00.CDBB */
                PARC = CDBC /* \_SB_.PCI0.AMW0.WM00.CDBC */
                PARD = CDBD /* \_SB_.PCI0.AMW0.WM00.CDBD */
                PARE = CDBE /* \_SB_.PCI0.AMW0.WM00.CDBE */
                PARF = CDBF /* \_SB_.PCI0.AMW0.WM00.CDBF */
                COMF = CFLG /* \_SB_.PCI0.AMW0.WM00.CFLG */
    ...
    Scope (_SB)
    {
        OperationRegion (WSMP, SystemIO, SSMI, 0x02)
        Field (WSMP, ByteAcc, NoLock, Preserve)
        {
            SMIP,   8, 
            SMIS,   8
        }
    ...
    OperationRegion (SNVS, SystemMemory, 0xBA187A98, 0x034B)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0xBA196C98, 0x0200)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        ...
        Device (EC0)
        {
            ...
            OperationRegion (EM51, SystemMemory, 0xFF000000, 0x1000)
            Field (EM51, ByteAcc, Lock, Preserve)
            {
                Offset (0x800), 
                    ,   6, 
                WMXD,   1, 
            ...
            OperationRegion (EA51, EmbeddedControl, Zero, 0xFF)
            Field (EA51, ByteAcc, Lock, Preserve)
            {
            }
        ...
        Device (BAT1)
        {
            ...
            Method (_BST, 0, NotSerialized)  // _BST: Battery Status
            {
                ...
                If (ECOK ())
                {
                    ...
                    If ((^^EC0.ORRF == One))
                    {
                        Local4 = (^^EC0.BFCB * BASC) /* \_SB_.PCI0.LPCB.BAT1.BASC */
                        Local2 = (^^EC0.GAU0 * Local4)
    ...
    OperationRegion (TOSN, SystemMemory, 0xBA186918, 0x0400)
    Field (TOSN, AnyAcc, Lock, Preserve)
    {
        ONVS,   32, 
        BRAD,   8, 
        VVEN,   16, 
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (LPEC, SystemIO, 0xFD60, 0x04)
        ...
        Method (PHMR, 1, NotSerialized)
        {
            ...
            {
                ECFB = Arg0
                Local0 = ECFD /* \_SB_.PCI0.LPCB.ECFD */
                ECFB = 0x23F4
            }
            Else
            {
        ...
        Method (EIOR, 3, NotSerialized)
        {
            Local1 = Arg0
            Local2 = Arg1
            Local3 = Arg2
            Local0 = Zero
            Local4 = (Local3 + 0x0100)
            Local5 = (Local1 << Local2)
            If ((Local5 & 0xFFFFFFFFFFFFFF00))
            {
                Local0 = (PHMR (Local4) << 0x08)
            }

            Local0 |= PHMR (Local3)
            Local0 = ((Local0 >> Local2) & Local1)
            Return (Local0)
        }

        Method (EIOW, 4, NotSerialized)
        {
            Local1 = Arg1
            Local2 = Arg2
            Local3 = Arg3
            Local4 = (Local3 + 0x0100)
            Local5 = (Local1 << Local2)
            Local6 = ((Arg0 << Local2) & Local5)
            If ((Local5 & 0xFFFFFFFFFFFFFF00))
            {
                Local0 = (PHMR (Local4) & ~(Local5 >> 0x08))
                Local0 |= (Local6 >> 0x08)
                PHMW (Local4, Local0)
            }

            Local0 = (((PHMR (Local3) & ~Local5) | Local6) & 
                0xFF)
            PHMW (Local3, Local0)
        }

        Method (ENUR, 2, NotSerialized)
        {
            Local0 = Zero
            Local2 = Arg1
            While (Local2)
            {
                Local2 -= One
                Local3 = (Local2 * 0x08)
                Local1 = ((Local2 << 0x08) + Arg0)
                Local0 |= (PHMR (Local1) << Local3)
            }

            Return (Local0)
        }

        Method (ENUW, 3, NotSerialized)
        {
            Local2 = Arg1
            While (Local2)
            {
        ...
        Method (ERBK, 2, NotSerialized)
        {
            Local2 = Arg1
            Name (ERBF, Buffer (Local2){})
            While (Local2)
            {
                Local2 -= One
                Local1 = ((Local2 << 0x08) + Arg0)
                ERBF [Local2] = PHMR (Local1)
            }

            Return (ERBF) /* \_SB_.PCI0.LPCB.ERBK.ERBF */
        }
    }

    Scope (_SB.PCI0.LPCB.EC0)
    {
        Method (EHKS, 1, NotSerialized)
        {
            If ((Arg0 == 0x03))
            {
                ECRD = One
            ...
            PNOT ()
            EIOW (Zero, One, Zero, 0x86F7)
        }
    }

    Scope (_SB.PCI0.LPCB.ACAD)
    {
    }
    ...
    Scope (_SB.PCI0)
    {
        Device (GFX0)
        {
            ...
            OperationRegion (PEGR, PCI_Config, Zero, 0x10)
            Field (PEGR, ByteAcc, Lock, Preserve)
            {
                Offset (0x02), 
                DVID,   16
            }
            ...
            Device (DD02)
            {
                ...
                Method (_BCL, 0, NotSerialized)  // _BCL: Brightness Control Levels
                {
                    ...
                    {
                        Debug = "===== _BCL Win8 ====="
                        Local0 = DerefOf (BCLN [0x0A])
                        BLFN [Zero] = Local0
                        Local1 = DerefOf (BCLN [0x04])
                        BLFN [One] = Local1
                        Return (BLFN) /* \_SB_.PCI0.GFX0.DD02.BLFN */
                    }
                    Else
                    {
                        Debug = "===== _BCL Old Win ====="
                        Local0 = DerefOf (BCL7 [0x07])
                        BLF7 [Zero] = Local0
                        Local1 = DerefOf (BCL7 [0x03])
                        BLF7 [One] = Local1
                        Return (BLF7) /* \_SB_.PCI0.GFX0.DD02.BLF7 */
                    }
                }
                ...
                Method (_BCM, 1, NotSerialized)  // _BCM: Brightness Control Method
                {
                    ...
                    If ((OSYS >= 0x07DC))
                    {
                        ...
                        {
                            Local1 = Match (BCLN, MEQ, Arg0, MTR, Zero, Zero)
                            Local3 = Match (IDPT, MEQ, IDPC, MTR, Zero, Zero)
                            If ((Local1 != Ones))
                            {
                    ...
                    ElseIf (((Arg0 >= Zero) && (Arg0 <= 0x64)))
                    {
                        Local1 = Match (BCL7, MEQ, Arg0, MTR, Zero, Zero)
                        Local3 = Match (IDPT, MEQ, IDPC, MTR, Zero, Zero)
                        If ((Local1 != Ones))
                        {
                            ^^^LPCB.EC0.BRTS = Local1
                ...
                Method (_BQC, 0, NotSerialized)  // _BQC: Brightness Query Current
                {
                    ...
                    If ((OSYS != 0x07DC))
                    {
                        Local1 = ^^^LPCB.EC0.BRTS /* \_SB_.PCI0.LPCB.EC0_.BRTS */
                        Local0 = DerefOf (BCL7 [Local1])
                        Return (Local0)
                    }
                    Else
                    {
                        Local1 = ^^^LPCB.EC0.BRTS /* \_SB_.PCI0.LPCB.EC0_.BRTS */
                        Local0 = DerefOf (BCLN [Local1])
                        Return (Local0)
                    }
                }
            }
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Scope (\_SB.PCI0.LPCB.EC0)
        {
            Method (VAFC, 6, NotSerialized)
            {
                Return (SABI (Arg0, Arg1, Arg2, Arg3, Arg4, Arg5))
            }
        }

        Scope (\_SB)
        {
            Method (SABI, 6, NotSerialized)
            {
                ...
                TSFR [0x04] = Zero
                TSFR [0x05] = Zero
                CreateDWordField (Arg0, Zero, SAB0)
                CreateDWordField (Arg1, Zero, SAB1)
                CreateDWordField (Arg2, Zero, SAB2)
                CreateDWordField (Arg3, Zero, SAB3)
                CreateDWordField (Arg4, Zero, SAB4)
                CreateDWordField (Arg5, Zero, SAB5)
                If ((SAB0 == 0x9900))
                {
                    ^PCI0.LPCB.EIOW (SAB0, 0xFF, Zero, 0x20FB)
                    ^PCI0.LPCB.EIOW (SAB1, 0xFF, Zero, 0x21FB)
                    ^PCI0.LPCB.EIOW (SAB2, 0xFF, Zero, 0x22FB)
                    ^PCI0.LPCB.EIOW (SAB4, 0xFF, Zero, 0x24FB)
                    KSMI (0x02)
                    Local2 = ^PCI0.LPCB.EIOR (0xFF, Zero, 0x23FB)
                    Local3 = ^PCI0.LPCB.EIOR (0xFF, Zero, 0x24FB)
                    Local4 = ^PCI0.LPCB.EIOR (0xFF, Zero, 0x24FB)
                    TSFR [Zero] = SAB0 /* \_SB_.SABI.SAB0 */
                    TSFR [One] = SAB1 /* \_SB_.SABI.SAB1 */
                    TSFR [0x02] = SAB2 /* \_SB_.SABI.SAB2 */
                    TSFR [0x03] = Local2
                    TSFR [0x04] = Local3
                    Return (TSFR) /* \_SB_.SABI.TSFR */
                }

                SBMF = SAB0 /* \_SB_.SABI.SAB0 */
                SBSF = SAB1 /* \_SB_.SABI.SAB1 */
                SBCF = SAB2 /* \_SB_.SABI.SAB2 */
                SBB1 = SAB3 /* \_SB_.SABI.SAB3 */
                SBB2 = SAB4 /* \_SB_.SABI.SAB4 */
                SBB3 = SAB5 /* \_SB_.SABI.SAB5 */
                KSMI (Zero)
                TSFR [Zero] = SBMF /* \SBMF */
                TSFR [One] = SBSF /* \SBSF */
                TSFR [0x02] = SBCF /* \SBCF */
        ...
        Method (OPEC, 0, NotSerialized)
        {
            If ((OSYS >= 0x07DC))
            {
                EIOW (0x04, 0x07, Zero, 0xA3F4)
            }
            ElseIf ((OSYS >= 0x07D9))
            {
                EIOW (0x03, 0x07, Zero, 0xA3F4)
            }
            ElseIf ((OSYS >= 0x07D6))
            {
                EIOW (One, 0x07, Zero, 0xA3F4)
                OSTY = One
            }
            ElseIf ((OSYS == 0x03E8))
            {
                EIOW (0x02, 0x07, Zero, 0xA3F4)
            }
            ElseIf ((OSYS < 0x07D6))
            {
                If ((OSYS != Zero))
                {
                    EIOW (Zero, 0x07, Zero, 0xA3F4)
                }
            }
        }
    }
